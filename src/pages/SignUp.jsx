    ...
    <div className='p-4 py-12 md:py-4 px-2 lg:px-8 xl:px-32 inter-500 min-h-[80vh]'>
      <div className="h-full p-4 flex justify-center md:bg-gray-100 rounded-xl">
        <div className="w-full md:w-1/3">
          <div className="text-3xl text-center font-bold">Kayıt Ol</div>
          <div className="text-sm text-gray-500 text-center mt-1">Kayıt olmak için lütfen formu eksiksiz doldurun.</div>
          <form className='mt-8 flex flex-col gap-4'>
            ...
            <div>
              ...
              <div className='flex h-fit hidden md:flex rounded-lg border border-gray-200 text-sm'>
                ...
                <input name='phone' type="text" className='p-2 outline-none bg-white rounded-lg w-full text-base' placeholder='Telefon Numarası' />
              </div>
            ...
            <div>
              ...
              <input name='password_repeat' type="password" className='p-2 outline-none bg-white rounded-lg border border-gray-200 w-full' placeholder='******' />
            </div>
            <div>
              <div className="text-gray-500 text-sm">Referans Kodu(isteğe bağlı)</div>
              <input name='reference_code' type="text" className='p-2 outline-none bg-white rounded-lg border border-gray-200 w-full' placeholder='' />
            </div>
