    ...
    <div className='p-4 py-12 md:py-4 px-2 lg:px-8 xl:px-32 inter-500 min-h-[80vh]'>
      <div className="h-full p-4 flex justify-center md:bg-gray-100 rounded-xl">
        <div className="w-full  md:w-1/3">
          <div className="text-3xl font-bold">Giriş Yap</div>
          <div className="text-sm text-gray-500 mt-1">Giriş yapmak için mail ve şifrenizi giriniz.</div>
          ...
          <button type="submit" className="bg-white border dark:bg-stone-800 border-gray-200 w-full flex items-center gap-2 justify-center rounded-lg p-3 cursor-pointer">
          ...
          <button type="submit" className="bg-white border dark:bg-stone-800 mt-4 border-gray-200 w-full flex items-center gap-2 justify-center rounded-lg p-3 cursor-pointer">
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24" viewBox="0 0 48 48">
