...
const Blog = () => {
    return (
        <div className='p-4 px-2 lg:px-8 xl:px-32 inter-500'>
            <div className="grid grid-cols-4 rounded-lg overflow-hidden mt-8 bg-[var(--primary-light)] inter-500">
                <div className='rounded-lg font-bold w-full text-center p-2 text-white bg-[var(--primary)]'>
                    Kampanyalar
                </div>

            </div>
            <div className="mt-2 grid grid-cols-4 gap-8 inter-500">
                <div>
